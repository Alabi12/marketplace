...
class ProfessionalProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professional_profile" do
    assert_difference("ProfessionalProfile.count") do
      post professional_profiles_url, params: { professional_profile: { bio: @professional_profile.bio, specialties: @professional_profile.specialties, user_id: @professional_profile.user_id } }
    end
  ...
  test "should update professional_profile" do
    patch professional_profile_url(@professional_profile), params: { professional_profile: { bio: @professional_profile.bio, specialties: @professional_profile.specialties, user_id: @professional_profile.user_id } }
