class ProfessionalProfilesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to professional_profiles_path, status: :see_other, notice: "Professional profile was successfully destroyed." }
  ...
  private
    ...
    def professional_profile_params
      params.expect(professional_profile: [ :user_id, :bio, :specialties ])
    end
end
